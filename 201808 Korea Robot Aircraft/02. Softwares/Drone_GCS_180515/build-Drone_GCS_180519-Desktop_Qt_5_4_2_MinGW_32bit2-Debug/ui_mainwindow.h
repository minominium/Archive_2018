...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        label->setGeometry(QRect(460, 60, 671, 51));
        ...
        label_2->setGeometry(QRect(1330, 30, 111, 101));
        label_2->setPixmap(QPixmap(QString::fromUtf8("../Robit_Logo_1.png")));
        label_2->setScaledContents(true);
        //widget = new QCustomPlot(centralWidget);
        //widget->setObjectName(QStringLiteral("widget"));
        //widget->setGeometry(QRect(920, 870, 120, 80));
        layoutWidget = new QWidget(centralWidget);
        layoutWidget->setObjectName(QStringLiteral("layoutWidget"));
        layoutWidget->setGeometry(QRect(10, 150, 1471, 791));
        ...
        sizePolicy2.setHeightForWidth(ui_webView->sizePolicy().hasHeightForWidth());
        ui_webView->setSizePolicy(sizePolicy2);
        ui_webView->setMinimumSize(QSize(1010, 520));
        ui_webView->setMaximumSize(QSize(1020, 520));
        ui_webView->setUrl(QUrl(QStringLiteral("about:blank")));
        ...
        sizePolicy2.setHeightForWidth(ui_group_Emergency->sizePolicy().hasHeightForWidth());
        ui_group_Emergency->setSizePolicy(sizePolicy2);
        ...
        sizePolicy3.setHeightForWidth(ui_button_auto->sizePolicy().hasHeightForWidth());
        ui_button_auto->setSizePolicy(sizePolicy3);
        ...
        sizePolicy2.setHeightForWidth(ui_group_GPS_Point->sizePolicy().hasHeightForWidth());
        ui_group_GPS_Point->setSizePolicy(sizePolicy2);
        ...
        sizePolicy2.setHeightForWidth(ui_group_port->sizePolicy().hasHeightForWidth());
        ui_group_port->setSizePolicy(sizePolicy2);
        ui_group_port->setMaximumSize(QSize(400, 150));
        layoutWidget3 = new QWidget(ui_group_port);
        layoutWidget3->setObjectName(QStringLiteral("layoutWidget3"));
        layoutWidget3->setGeometry(QRect(10, 20, 361, 65));
        ...
        gridLayout_4->addWidget(ui_group_Gripper, 1, 2, 1, 1);

        groupBox = new QGroupBox(layoutWidget);
        groupBox->setObjectName(QStringLiteral("groupBox"));
        layoutWidget6 = new QWidget(groupBox);
        layoutWidget6->setObjectName(QStringLiteral("layoutWidget6"));
        layoutWidget6->setGeometry(QRect(20, 20, 971, 217));
        ...
        ui_textBrowser = new QTextBrowser(layoutWidget6);
        ...
        ui_textBrowserWP = new QTextBrowser(layoutWidget6);
        ...
        ui_textBrowserLat = new QTextBrowser(layoutWidget6);
        ...
        ui_textBrowserLong = new QTextBrowser(layoutWidget6);
        ...
        ui_textBrowserAlt = new QTextBrowser(layoutWidget6);
        ...
        ui_textBrowserAlt_2 = new QTextBrowser(layoutWidget6);
        ...
        ui_textBrowserAlt_3 = new QTextBrowser(layoutWidget6);
        ...
        label_11->setGeometry(QRect(40, 40, 311, 91));
